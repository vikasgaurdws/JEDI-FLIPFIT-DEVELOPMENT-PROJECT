...
public interface FlipFitGymOwnerDAO {
     ...
     */
    void editFlipFitGymOwnerDetails(FlipFitGymOwner FlipFitGymOwnerDetails);
     ...
     */
    void editGym(FlipFitGym gymDetails);
     ...
     */
    List<FlipFitGym> getGymsOfFlipFitGymOwner(String FlipFitGymOwnerId);
     ...
     */
    List<Slot> getPossibleSlots(String gymId);
